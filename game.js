...
new GLTFLoader().load("assets/models/diano_racer_trex.glb",g=>{dino=g.scene;dino.scale.setScalar(.58);dino.position.set(0,0,1.2);dino.rotation.y=0;dino.traverse(o=>{if(o.isMesh)o.castShadow=true});scene.add(dino)},undefined,e=>console.warn("GLB load failed",e));
